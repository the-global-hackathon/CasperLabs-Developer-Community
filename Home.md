...
Powered by the first implementation of Vlad Zamfir’s CBC-Casper proof-of-stake protocol, a standard that is most efficient for blockchain optimizing resources to maximize processing power toward actual transactions, CasperLabs removes barriers that prevent mainstream blockchain adoption by being completely open source, decentralized, and highly secure. 
...
- [Set up your  Local Environment](https://github.com/zie1ony/casperlabs-smart-contract-template)
- [Test your Local Environment Setup](https://github.com/zie1ony/casperlabs-smart-contract-template)
...
- [CasperLabs Community Forum](https://forums.casperlabs.io/)
  ...
  This space is provided for technical discussions on using the Casper Node, building networks, smart contracts and client tools. You can obtain support for frequently asked technical questions and Pose questions to the CasperLabs core development team.

- [Telegram Channel](https://telegram.org/)

  Our telegram channel is a general channel for anyone to join to receive consistent company updates & submit any questions you may have.

- [Discord Channel](https://discord.gg/Q38s3Vh)

  Although anyone may join, the Discord Channel is provided for a technical audience, a place where members or our community specifically interact with our internal developer team for any technical, node or testing related questions.
